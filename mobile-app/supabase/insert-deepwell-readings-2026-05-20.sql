...
begin
  ...
  with source_rows (
    ...
    values
      ('00:00'::time, 40, 20, 14.8, 48, 458.7, 453.0, 464.0, 33.83, null, null, '7/8 TURN'),
      ('00:30'::time, 40, 25, 11.9, 48, 459.7, 456.1, 467.1, 33.81, null, null, '7/8 TURN'),
      ('01:00'::time, 45, 35, 10.2, 38, 475.8, 471.3, 480.0, 23.98, null, null, '3/4 TURN'),
      ('01:30'::time, 45, 35, 10.8, 38, 467.2, 473.1, 470.1, 23.99, null, null, '3/4 TURN'),
      ...
      ('03:30'::time, 40, 40, 12.7, 38, 472.9, 467.7, 475.4, 24.02, null, null, '3/4 TURN'),
      ('04:00'::time, 50, 35, 10.8, 38, 471.1, 467.7, 470.4, 24.67, null, null, '3/4 TURN'),
      ('04:30'::time, 50, 35, 14.1, 38, 475.4, 470.3, 475.8, 24.07, null, null, '3/4 TURN'),
      ('05:00'::time, 50, 35, 14.2, 42, 474.2, 437.8, 471.9, 27.72, null, null, '3/4 TURN'),
      ...
      ('07:30'::time, 35, 10, 19.6, 48, 478.6, 473.3, 479.2, 33.52, null, null, '7/8 TURN SUPMEA'),
      ...
      ('16:30'::time, 35, 13, 18.9, 47, 441.2, 435.3, 462.4, 32.76, null, null, '3/4 TURN'),
      ...
      ('22:30'::time, 40, 24, 12.8, 42, 442.9, 438.7, 449.3, 27.72, null, 51102, '3/4 TURN'),
